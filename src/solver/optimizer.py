...
def make_optimizer(
    ...
    if optimizer == "sgd":
        ...
        #     if 'SideNet' in name or 'text_refine' in name:
        #         params_list += [{'params': param, 'lr': 0.00005, 'weight_decay': weight_decay}]
        #         count += 1
        #
        #     else:
        #         params_list += [{'params': param}]
        # print(':::: {} number of params has reduced LR.'.format(count))
